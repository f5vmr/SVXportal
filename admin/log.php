...
$sql ="SELECT * FROM `ReflectorNodeLog` where   Type= '3' $station_query $tg_query ORDER BY `ReflectorNodeLog`.`Id` DESC limit $logoffset,$size ";
...
if(!$_GET['only_table'])
{
     ...
     */
    $sql1 ="SELECT count(*) FROM `ReflectorNodeLog` where  Type= '3'  $station_query $tg_query";
