      ...
      <div class="row no-gutters row-bordered row-border-light">
        ...
        <div class="col-md-9">
          <div class="tab-content">
            <div class="tab-pane fade <?php if($_GET['password'] !="1") echo "active show";?> " id="account-general">
            ...
            <div class="tab-pane fade <?php if($_GET['password'] =="1") echo "active show";?>" id="account-change-password">
